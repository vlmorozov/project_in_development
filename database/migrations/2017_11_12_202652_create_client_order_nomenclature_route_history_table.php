...
class CreateClientOrderNomenclatureRouteHistoryTable extends Migration {
	...
	public function up()
	{
		Schema::create('client_order_nomenclature_route_history', function(Blueprint $table)
		{
	...
	{
		Schema::drop('client_order_nomenclature_route_history');
	}
